package graphicsEngine.oldPagedDemo.pages.demoPages.page3;

import graphicsEngine.utilities.TextAligner;
import graphicsEngine.parts.simpleParts.SimplePart;

import graphicsEngine.oldPagedDemo.pages.demoPages.page3.rotor.Output;
...
class Center extends SimplePart {
    ...
    private void drawPageMessage(@NotNull Graphics g) {
        ...
        TextAligner.drawStringCentered(g, "This is the oldPagedDemo page 3",
                new int[] {
                        location[0] + size[0] / 2,
                        location[1] + size[1] / 2});
    }
